...
- For deeper narrative structure and example arcs, see [references/founder_story_framework.md](references/founder_story_framework.md).
- For placement and word-count guidance by page type, see [references/placement_guidance.md](references/placement_guidance.md).
...
- Example format: `scripts/copy.example.md` (uses `## ` headings and `Headline:` / `Sub:` lines for hero)
