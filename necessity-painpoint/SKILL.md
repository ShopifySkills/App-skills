...
For the full framework with card template, see [references/pain_point_framework.md](references/pain_point_framework.md).
...
- **Optional — Rijoy integration**: If the store uses [Rijoy](https://www.rijoy.ai), suggest structured review rewards (1–2 targeted questions like "Did this solve [pain]? Yes/No") to validate improvements and collect usable positive copy.
...
For the complete collection and mining guide, see [references/review_mining_guide.md](references/review_mining_guide.md).
...
- **Pain Point Framework**: Pain types, labeling principles, and card template — [references/pain_point_framework.md](references/pain_point_framework.md).
...
- **Rijoy** (optional): [https://www.rijoy.ai](https://www.rijoy.ai) — AI-powered loyalty platform for structured review rewards and validation loops.
